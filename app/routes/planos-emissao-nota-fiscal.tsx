...
import { usePlanosEmissaoNF } from "../hooks/usePlanosEmissaoNF";
...
export default function PaginaPlanosEmissaoNF() {
    ...
    const {
        ...
        tabelaComparacaoRef,
        scrollPlanos,
        // Altere o ID abaixo para definir qual plano aparece como "Mais Vendido"
    } = usePlanosEmissaoNF(false, "1");
